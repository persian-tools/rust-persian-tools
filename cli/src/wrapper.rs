...
pub fn add_commas(s: &str, _: &Args) -> String {
    commas::add_commas::add_commas(s)
}
pub fn remove_commas(s: &str, _: &Args) -> String {
    commas::remove_commas::remove_commas(s)
}
// ---
pub fn add_ordinal_suffix(s: &str, _: &Args) -> String {
    add_ordinal_suffix::add_ordinal_suffix(s)
}
// ---
pub fn remove_ordinal_suffix(s: &str, _: &Args) -> String {
    remove_ordinal_suffix::remove_ordinal_suffix(s)
}
// --- returns true|false
pub fn has_arabic(s: &str, _: &Args) -> String {
    arabic_chars::has_arabic(s).to_string()
}
// --- returns true|false
pub fn is_arabic(s: &str, _: &Args) -> String {
    arabic_chars::is_arabic(s).to_string()
}
pub fn to_arabic(s: &str, _: &Args) -> String {
...
// ---
pub fn fa_to_en(s: &str, args: &Args) -> String {
    digits::fa_to_en(s)
}
pub fn en_to_fa(s: &str, args: &Args) -> String {
    digits::en_to_fa(s)
}
pub fn en_to_ar(s: &str, args: &Args) -> String {
    digits::en_to_ar(s)
}
pub fn ar_to_en(s: &str, args: &Args) -> String {
    digits::ar_to_en(s)
}
pub fn fa_to_ar(s: &str, args: &Args) -> String {
    digits::fa_to_ar(s)
}
pub fn ar_to_fa(s: &str, args: &Args) -> String {
    digits::ar_to_fa(s)
}
// --- card numbers separated with commas
pub fn extract_card_number(s: &str, args: &Args) -> String {
...
// ---
pub fn remove_half_space(s: &str, args: &Args) -> String {
    half_space::remove_half_space(s)
}
pub fn add_half_space(s: &str, args: &Args) -> String {
    half_space::add_half_space(s)
}

// ---
pub fn verify_iranian_legal_id(s: &str, args: &Args) -> String {
    legal_id::verify_iranian_legal_id(s).is_ok().to_string()
}
// ---
pub fn verify_iranian_national_id(s: &str, args: &Args) -> String {
...
// ---
pub fn is_sheba_valid(s: &str, args: &Args) -> String {
...
// ---
pub fn number_to_words_str(s: &str, args: &Args) -> String {
