...
fn main() {
    ...
    match args.function {
        ...
        Function::FaToEn => handle(&args, wrapper::fa_to_en),
        Function::EnToFa => handle(&args, wrapper::en_to_fa),
        Function::EnToAr => handle(&args, wrapper::en_to_ar),
        Function::ArToEn => handle(&args, wrapper::ar_to_en),
        Function::FaToAr => handle(&args, wrapper::fa_to_ar),
        Function::ArToFa => handle(&args, wrapper::ar_to_fa),
