...
pub fn is_persian<S>(str: S, is_complex: bool) -> bool where S: Into<String>{
...
mod tests {
    ...
    fn is_persian_test() {
		...
		assert_eq!(is_persian("آیا سیستم میتواند گزینه های دیگری را به اشتباه به عنوان متن فارسی تشخیص دهد؟",false),true);
